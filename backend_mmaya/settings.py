...
SECRET_KEY = 'django-insecure-_g=@%gg=#!h%3ag9w$j2*-33u@4_j(^j9akn95&6edcy=w0*#j'
...
DATABASES = {
    ...
    'default': {
        ...
        'USER': 'postgres',
        'PASSWORD': '123456',
        'HOST': '172.10.14.66',  # Puedes dejarlo como 'localhost' si estás ejecutando PostgreSQL en tu máquina local
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000',  # Por ejemplo, tu frontend en desarrollo
